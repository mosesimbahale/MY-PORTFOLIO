   ...
   <div class="bg-white text-center p-20">
     ...
     <div className="text-center mt-2">
                  ...
                  <div className="flex justify-center m-2 text-gray-700 mt-2">
                    < FaBriefcase size="20px" color='black'  />
                    <p className='pl-4 font-semibold'>Software Engineer - Ml</p>
                  </div>

                  <div className="flex justify-center m-2 text-gray-700">
                    <FaUniversity color='black'  size="20px" />
                    <p className='pl-4 font-semibold'>University of KCA,  Bachelors of Science in Software Engineering</p>
                  </div>
</div>
