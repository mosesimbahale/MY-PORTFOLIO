      ...
      <section class=" py-20 2xl:py-40 bg-gray-900  ">                                                   
        ...
        <div class="relative container px-4 mx-auto">
          <div class="text-center mb-20">
            <span class="text-lg text-indigo-600 font-bold">Have a question?</span>
            <h2 class="mt-10 text-5xl font-bold font-heading text-white">Contact Me!</h2>
          </div>
          <div class="max-w-4xl mx-auto">
            <div class="flex flex-wrap -mx-4 mb-20">
              ...
              <div class="w-full lg:w-1/2 px-4">
                <div class="py-10 px-8 mb-4 bg-gray-600 rounded-lg">
                  <div class="flex items-center">
                    <span class="flex items-center justify-center w-12 h-14 mr-8 bg-indigo-600 rounded ">
                    ...
                    <p class="text-lg font-bold text-white">+254  0743755328</p>
                  </div>
                </div>
                <div class="py-10 px-8 mb-10 bg-gray-600 rounded-lg">
                  <div class="flex items-center">
                    <span class="flex items-center  w-16 h-12 mr-8 bg-indigo-600 rounded">
                    ...
                    <p class="text-lg font-bold text-white">mosesimbahale.developer@gmail.com</p>
                  </div>
                </div>
                <div class="py-10 px-8">
                  <div class="flex">
                    <span class="flex-shrink-0 flex items-center justify-center w-14 h-12 mr-8 bg-indigo-600 rounded-lg">
                    ...
                    <div>
                      <div class="pb-4 pr-16 mb-6 border-b border-gray-500">
                        <p class="text-lg font-bold text-white">Nairobi, Kenya</p>
                        <p class="text-lg font-bold text-white">1295, KITALE</p>
                      </div>
