...
<section class="relative py-20 2xl:py-40 bg-gray-800 mt-5">
  ...
  <div class="relative container px-4 mx-auto">
    <div class="text-center mb-20">
      ...
      <h2 class="mt-10 text-5xl font-bold font-heading text-white">Contact with us</h2>
    </div>
    <div class="max-w-4xl mx-auto">
      <div class="flex flex-wrap -mx-4 mb-20">
        <div class="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
          <div class="bg-gray-600 rounded-b-lg">
            <img class="h-64 w-full rounded-lg object-cover" src="https://image.freepik.com/free-photo/contacting-with-friends-via-computer_329181-14587.jpg" alt=""/>
            <div class="px-14 py-8">
              ...
              <div class="md:text-right"><a class="inline-block px-12 py-4 border border-gray-300 hover:border-gray-200 rounded-full font-bold text-white" href="#">Message</a></div>
            </div>
          </div>
        </div>
        <div class="w-full lg:w-1/2 px-4">
          <div class="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
            <div class="flex items-center">
              ...
              <p class="text-lg font-bold text-white">+44 20457523 00 01</p>
            </div>
          </div>
          <div class="py-6 px-8 mb-10 bg-gray-600 rounded-lg">
            <div class="flex items-center">
              ...
              <p class="text-lg font-bold text-white">support@shuffle.dev.dev</p>
            </div>
          </div>
          <div class="py-6 px-8">
            <div class="flex">
              ...
              <div>
                <div class="pb-4 pr-16 mb-6 border-b border-gray-500">
                  <p class="text-lg font-bold text-white">Bayswater, London</p>
                  <p class="text-lg font-bold text-white">W16EG, UK</p>
                </div>
                <p class="text-gray-400">The one est bad, semper six. At sem quis, congue</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="text-center">
        <p class="mb-4 text-xl text-gray-300">The brown fox jumps over the lazy dog.</p>
        <a class="inline-flex text-blue-400 hover:text-blue-500 font-bold" href="#">
          <span>Learn more</span>
          <svg class="ml-4 w-4 h-5" width="19" height="20" viewbox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
