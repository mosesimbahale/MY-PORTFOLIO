...
const Footer = () => {
  return (
    <>
      <section class=" py-20 2xl:py-40  lg:mx-24">
          ...
          <div class="max-w-4xl mx-auto">
            <div class="flex flex-wrap -mx-4 mb-20">
              ...
              <div class="w-full lg:w-1/2 px-4 ">
                <div class="py-10 px-8 mb-4 bg-gray-800 rounded-2xl shadow-lg">
                  <div class="flex items-center">
                    <span class="flex items-center justify-center w-20 h-20 mr-8 bg-orange-400 rounded ">
                      <svg
                        class="w-4 h-4"
                        width="18"
                        height="18"
                ...
                <div class="py-10 px-8 mb-10 bg-gray-800 rounded-2xl shadow-lg">
                  <div class="flex items-center">
                    <span class="flex items-center  w-20 h-20 mr-4 bg-orange-400 rounded">
                      <svg
                        class="w-5 h-3"
                        width="21"
                        height="14"
                    ...
                    <p class="text-lg font-bold text-white">
                      mosesimbahale.developer@gmail.com
                    </p>
                  </div>
                </div>
