...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden  bg-gray-900 shadow-xl flex flex-wrap items-center justify-between relative md:w-48 z-10 py-4 px-6">
