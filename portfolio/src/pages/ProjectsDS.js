...
<div class="w-full  mb-2 justify-center rounded-lg text-white bg-gray-900">
   ...
   <div class="p-5 pt-1 flex-wrap  flex items-center gap-2 justify-center">
      ...
      <div class="bg-gradient-to-r  from-gray-800 to-gray-700   flex-auto  w-42 h-42   shadow-lg    rounded-lg">
         <div class="md:p-7 p-4">
            <h2 class="text-xl text-center text-gray-200 capitalize">10$</h2>
            <h3 class="text-sm  text-gray-400  text-center">delivery cost</h3>
         </div>
      </div>
      ...
      <div class="bg-gradient-to-r  from-gray-800 to-gray-700   flex-auto  w-42 h-42   shadow-lg    rounded-lg">
        ...
        <div className="lg:flex items-center justify-center w-full">
          ...
          <div className="bg-gradient-to-r  from-gray-800 to-gray-700 lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 p-6 border border-gray-700 text-white rounded shadow-xl">
            <div className="flex items-center border-b border-indigo-500 mb-6">
              <MdDataExploration size="50" color="red" />
          ...
          <div className="bg-gradient-to-r  from-orange-500 to-orange-400 lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 p-6 border border-gray-700  rounded shadow-xl">
            <div className="flex items-center border-b border-indigo-500 mb-6">
              <MdDataExploration size="50" color="black" />
              <div className="flex items-start justify-between w-full">
                <div className="pl-3 w-full">
                  <p className="text-xl font-bold leading-5 ">
                    Loan Payment prediction
                  </p>
                  <p className="text-xs leading-normal pt-2 text-gray-900">
            ...
            <div className="px-2">
              <h2 className="font-medium">Problem statement</h2>
              <p className="text-sm leading-5 py-4 text-gray-900">
                A group of people interested in dogecoin, the currency and a bit
                of side for the meme and dof that we all know and love. These
                cases are perfectly simple and easy to distinguish.
              </p>
            ...
            <div className="px-2">
              ...
              <div className="flex flex-wrap">
                <div className="py-2 px-4 m-2 text-xs leading-3 text-gray-900 rounded-full bg-white">
                  #React
                </div>
                <div className="py-2 px-4 m-2 text-xs leading-3 text-gray-900 rounded-full bg-white">
                  #Tailwind
      ...
      <div className="pb-8 px-10 w-full ">
        ...
        <div className="bg-gradient-to-r  from-green-400 to-green-500 lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 p-6 border border-gray-700 text-gray-900  rounded shadow-xl">
            <div className="flex items-center border-b border-indigo-500 mb-6">
            ...
            <div className="px-2">
              ...
              <div className="flex flex-wrap">
                <div className="py-2 px-4 m-2 text-xs leading-3 text-indigo-800 rounded-full bg-white">
                  #React
                </div>
                <div className="py-2 px-4 m-2 text-xs leading-3 text-indigo-800 rounded-full bg-indigo-300">
                  #Tailwind
          ...
          <div className="bg-gradient-to-r  from-gray-900 to-gray-800 lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 p-6 border border-gray-700 text-red-600  rounded shadow-xl">
            <div className="flex items-center border-b border-indigo-500 mb-6">
              <MdDataExploration size="50" color="brown" />
              <div className="flex items-start justify-between w-full">
                <div className="pl-3 w-full">
 ...
 <div className="py-4  bg-green-500 w-full text-gray-900">


<div className= "text-gray-900 md:mx-40">
