        ...
        <div className="py-4 container px-6 mx-auto flex flex-col md:flex-row items-start md:items-center justify-between pb-4 border-b border-gray-600  ">
          ...
          <div className="mt-6 md:mt-0">
            ...
            <Link to="/projects" className="">
              <button className="border border-indigo-500 m-3 bg-gray-700 dark:bg-gray-700 focus:outline-none transition duration-150 ease-in-out rounded hover:bg-indigo-500 text-white dark:hover:bg-indigo-500 dark:text-white px-5 py-2 text-sm ">
                All projects
              </button>
            </Link>
